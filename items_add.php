...
$add_variation = (isset($_POST['add_variation'])) ? $_POST['add_variation'] : NULL;
...
$parsed_response = '';
if (!empty($_POST)) {
	$response_body = file_get_contents(API_HOST . '/' . API_VERSION . '/items/add', false, $context);
...
<body>
	...
	<h2>POST /<?php echo API_VERSION; ?>/items/add</h2>
	<form method="POST" action="items_add.php">
		...
		variation を登録する <input type="checkbox" name="add_variation" value="1" <?php if($add_variation): ?>checked="checked"<?php endif; ?>><br>
