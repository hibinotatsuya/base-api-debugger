...
$parsed_response = '';
if (!empty($_POST)) {
	$response_body = file_get_contents(API_HOST . '/' . API_VERSION . '/item_categories/detail/' . $item_id, false, $context);
...
<body>
	...
	<h2>GET /<?php echo API_VERSION; ?>/item_categories/detail/:item_id</h2>
	<form method="POST" action="item_categories_detail.php">
