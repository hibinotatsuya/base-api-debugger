...
$parsed_response = '';
if (!empty($_POST)) {
	$response_body = file_get_contents(API_HOST . '/' . API_VERSION . '/item_categories/add', false, $context);
...
<body>
	...
	<h2>POST /<?php echo API_VERSION; ?>/item_categories/add</h2>
	<form method="POST" action="item_categories_add.php">
