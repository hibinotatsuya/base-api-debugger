...
$parsed_response = '';
if (!empty($_POST)) {
	$response_body = file_get_contents(API_HOST . '/' . API_VERSION . '/items/delete_variation', false, $context);
...
<body>
	...
	<h2>POST /<?php echo API_VERSION; ?>/items/delete_variation</h2>
	<form method="POST" action="items_delete_variation.php">
