...
$parsed_response = '';
if (!empty($_POST)) {
	$response_body = file_get_contents(API_HOST . '/' . API_VERSION . '/items/add_image', false, $context);
...
<body>
	...
	<h2>POST /<?php echo API_VERSION; ?>/items/add_image</h2>
	<form method="POST" action="items_add_image.php">
		...
		image_url <input type="text" name="image_url" value="<?php echo $image_url; ?>" style="width:300px"><br>
