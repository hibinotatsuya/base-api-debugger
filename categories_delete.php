...
$parsed_response = '';
if (!empty($_POST)) {
	$response_body = file_get_contents(API_HOST . '/' . API_VERSION . '/categories/delete', false, $context);
...
<body>
	...
	<h2>POST /<?php echo API_VERSION; ?>/categories/delete</h2>
	<form method="POST" action="categories_delete.php">
